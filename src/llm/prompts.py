...
class RAGPromptBuilder:
    ...
    def build_prompt(
        ...
        prompt = f"""You are a helpful assistant for a user's personal ebook library.
...
- Ignore exercises or quiz questions; focus on the user's actual question
- Summarize key points when appropriate
- Cite page numbers when referencing specific information
- If context is insufficient, suggest rephrasing or adjusting retrieval settings
...
- Suggest rephrasing the question or increasing the retrieval percentage
- For general questions ("what is this book about"), suggest 5-10% retrieval
